...
<div class="row " id="res_front_end">
    ...
    <div class="row " id="res_front_end">
        ...
        <div class="col">
            <input type="text" name="custo_hora_front_end" class="moneyMask" value="{{$projeto->levantamento->custo_hora_front_end ?? '20.00'}}">
        </div>
        <div class="col">
    ...
    <div class="row" >
        ...
        <div class="col">
            <input type="text" name="custo_hora_back_end" class="moneyMask" value="{{$projeto->levantamento->custo_hora_back_end ?? '20.00'}}">
        </div>
        <div class="col">
    ...
    <div class="row">
        ...
        <div class="col">
            <input type="text" name="custo_hora_ux" class="moneyMask" value="{{$projeto->levantamento->custo_hora_ux ?? '20.00'}}">
        </div>
        <div class="col">
    ...
    <div class="row">
        ...
        <div class="col">
            <input type="text" name="custo_hora_gerenciamento" class="moneyMask" value="{{$projeto->levantamento->custo_hora_gerenciamento ?? '20.00'}}">
        </div>
        <div class="col">
...
<div class="group">
    ...
    <div class="row row-items">
        <div class="col-3 border-end border-start"><input type="text" required class="descricao" name="descricao[grupo_{{$kGrupo}}][]" value="{{$vTela->descricao}}" placeholder="..." ></div>
        <div class="col border-end"><input type="text" class="front_end porcMask" name="front_end[grupo_{{$kGrupo}}][]" value="{{$vTela->front_end}}" placeholder="0" ></div>
        <div class="col border-end"><input type="text" class="back_end porcMask" name="back_end[grupo_{{$kGrupo}}][]" value="{{$vTela->back_end}}" placeholder="0" ></div>
        <div class="col border-end"><input type="text" class="ux porcMask" name="ux[grupo_{{$kGrupo}}][]" value="{{$vTela->ux}}" placeholder="0" ></div>
        <div class="col border-end"><input type="text" class="gerenciamento porcMask" name="gerenciamento[grupo_{{$kGrupo}}][]" value="{{$vTela->gerenciamento}}" placeholder="0" ></div>
        <button class="addRow">
    ...
    <div class="row row-items">
        ...
        <div class="col border-end"><input type="text" class="front_end porcMask" name="front_end[grupo_0][]" placeholder="0" ></div>
        <div class="col border-end"><input type="text" class="back_end porcMask" name="back_end[grupo_0][]"  placeholder="0" ></div>
        <div class="col border-end"><input type="text" class="ux porcMask" name="ux[grupo_0][]"  placeholder="0" ></div>
        <div class="col border-end"><input type="text" class="gerenciamento porcMask" name="gerenciamento[grupo_0][]"  placeholder="0" ></div>
        <button class="addRow">
            <i class="fa-solid fa-plus"></i>
        </button>
        <button class="delRow">
...
<div class="group">
    ...
    <div class="row row-items">
        <div class="col-3 border-end border-start"><input type="text" required class="descricao" name="descricao[grupo_0][]" placeholder="..." ></div>
        <div class="col border-end"><input type="text" class="front_end" name="front_end[grupo_0][]" placeholder="0" ></div>
