            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                <li>
                    <a class="dropdown-item"
                        href="{{ route('admin.projetos.edit',['id'=>$item->id]) }}">
                        Editar
                    </a>
                </li>
                <li>
                    <a class="dropdown-item btn-destroy" href="{{route('admin.projetos.delete',['id'=>$item->id])}}">
                        Excluir
                    </a>
                </li>
...
@empty
<div class="row">
    <div class="col"><h4>Nenhum Projeto cadastrado</h4></div>
</div>
@endforelse
