...
@section('content')
<form action="{{route('admin.clientes.store')}}" id="formStore" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="card-body">
                    ...
                    <div class=" row">
                        ...
                        <div class="col-sm-4 col-12 mt-3">
                            ...
                            <input type="text"  class="form-control cad-form" name="razao_social">
                        </div>
                        <div class="col-sm-4 col-12 mt-3">
                            <label for="" class="titulo">CNPJ:</label>
                            <input type="text" class="form-control cad-form cnpjMask" nam="cnpj">
                        </div>
                        ...
                        <div class="col-sm-3 col-12 mt-3">
                            ...
                            <input type="email" name="email" class="form-control cad-form" >
                        </div>
                        <div class="col-sm-3 col-12 mt-3">
                            <label for="" class="titulo">CEP:</label>

                            <div class="d-flex gap-2 mb-3">
                                <input type="text" class="form-control cepMask" id="buscaCep" name="cep" placeholder="00.0000-000" >
                        ...
                        <div class="col-sm-3 col-8 mt-3">
                            ...
                            <input type="text" name="endereco" class="form-control cad-form">
                        </div>
                        <div class="col-sm-2 col-4 mt-3">
                            <label for="" class="titulo">Número:</label>
                            <input type="text" name="numero" class="form-control cad-form">
                        </div>
                        <div class="col-sm-2 col-12 mt-3">
                            <label for="" class="titulo">Complemento:</label>
                            <input type="text" name="complemento" class="form-control cad-form">
                        </div>
                        <div class="col-sm-3 col-12 mt-3">
                            <label for="" class="titulo">Bairro:</label>
                            <input type="text" name="bairro" class="form-control cad-form">
                        </div>
                        <div class="col-sm-3 col-8 mt-3">
                            <label for="" class="titulo">Cidade:</label>
                            <input type="text" name="cidade" class="form-control cad-form">
                        </div>
                        <div class="col-sm-2 col-4 mt-3">
                            <label for="" class="titulo">Estado:</label>
                            <input type="text" name="estado" class="form-control cad-form">
                        </div>
