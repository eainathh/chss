<div class="sidenav-header">
  ...
  <a class="navbar-brand m-0" href="{{route('admin.index')}}" target="_blank">
    <img src="{{asset('img/logo-dvelopers.png')}}" class="navbar-brand-img h-100" alt="main_logo">
...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link  " href="{{route('admin.colaboradores.index')}}">
        <div class=" icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <li class="nav-item">
      <a class="nav-link  " href="">
        ...
        <span class="nav-link-text ms-1">Formulário Chss</span>
      </a>
    </li>
...
<div class="sidenav-footer mx-3 ">
  ...
  <a class="btn bg-gradient-primary mt-3 w-100" href="#">Suporte Dvelopers</a>
</div>